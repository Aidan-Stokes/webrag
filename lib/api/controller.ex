defmodule AONCrawler.API.Controller do
  @moduledoc """
  ...
  def health(conn, _params) do
    json(conn, %{
      ...
      services: %{
        ...
        embedding_client: AONCrawler.Indexer.EmbeddingClient.ready?()
      }
    })
  end
  ...
  def stats(conn, _params) do
    json(conn, %{
      crawler:
        AONCrawler.Crawler.Coordinator.get_stats() |> Map.take([:status, :pending, :completed]),
