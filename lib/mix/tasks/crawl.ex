defmodule Mix.Tasks.Crawl do
  ...
  def run(args) do
    ...
    discovered_urls = AONCrawler.Storage.load_discovered_urls(source_id)
    ...
    already_crawled = AONCrawler.Storage.crawled_urls()
    ...
    case AONCrawler.Crawler.Coordinator.start_crawl(urls_to_crawl,
